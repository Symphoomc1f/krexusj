...
public class NoAuthorityException extends RuntimeException {
     ...
     * @param cause  异常堆栈
     */
    public NoAuthorityException(Result result, Throwable cause) {
     ...
     * @param msg  错误消息
     */
    public NoAuthorityException(int code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }

    public NoAuthorityException(String code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }
     ...
     */
    public NoAuthorityException(Result result, String detail) {
     ...
     * @param cause  异常堆栈
     */
    public NoAuthorityException(Result result, String detail, Throwable cause) {
     ...
     * @param cause 异常堆栈
     */
    public NoAuthorityException(int code, String msg, Throwable cause) {
        super(msg, cause);
     ...
     * @param cause	异常堆栈
     */
    public NoAuthorityException(int code, Throwable cause) {
        super(cause);
        String msg = "";
