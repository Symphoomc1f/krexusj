...
public class ThreadException extends RuntimeException {
     ...
     * @param cause  异常堆栈
     */
    public ThreadException(Result result, Throwable cause) {
    ...
    public ThreadException(String code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }
     ...
     */
    public ThreadException(Result result, String detail) {
     ...
     * @param cause  异常堆栈
     */
    public ThreadException(Result result, String detail, Throwable cause) {
     ...
     * @param cause 异常堆栈
     */
    public ThreadException(int code, String msg, Throwable cause) {
        super(msg, cause);
     ...
     * @param cause	异常堆栈
     */
    public ThreadException(int code, Throwable cause) {
        super(cause);
        String msg = "";
