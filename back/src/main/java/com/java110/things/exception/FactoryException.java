...
public class FactoryException extends RuntimeException {
     ...
     * @param cause  异常堆栈
     */
    public FactoryException(Result result, Throwable cause) {
     ...
     * @param msg  错误消息
     */
    public FactoryException(int code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }

    public FactoryException(String code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }
     ...
     */
    public FactoryException(Result result, String detail) {
     ...
     * @param cause  异常堆栈
     */
    public FactoryException(Result result, String detail, Throwable cause) {
     ...
     * @param cause 异常堆栈
     */
    public FactoryException(int code, String msg, Throwable cause) {
        super(msg, cause);
