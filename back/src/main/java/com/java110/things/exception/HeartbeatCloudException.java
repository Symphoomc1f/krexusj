 ...
 */
public class HeartbeatCloudException extends RuntimeException {


    private Result result;
    private Throwable cause = this;

    public HeartbeatCloudException(){}
     ...
     * @param cause  异常堆栈
     */
    public HeartbeatCloudException(Result result, Throwable cause) {
     ...
     * @param msg  错误消息
     */
    public HeartbeatCloudException(int code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }

    public HeartbeatCloudException(String code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }
     ...
     */
    public HeartbeatCloudException(Result result, String detail) {
     ...
     * @param cause  异常堆栈
     */
    public HeartbeatCloudException(Result result, String detail, Throwable cause) {
     ...
     * @param cause 异常堆栈
     */
    public HeartbeatCloudException(int code, String msg, Throwable cause) {
        super(msg, cause);
     ...
     * @param cause	异常堆栈
     */
    public HeartbeatCloudException(int code, Throwable cause) {
        super(cause);
        String msg = "";
