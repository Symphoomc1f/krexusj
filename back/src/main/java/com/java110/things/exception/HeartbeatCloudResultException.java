package com.java110.things.exception;
 ...
 */
public class HeartbeatCloudResultException extends RuntimeException {


    private Result result;
    private Throwable cause = this;

    public HeartbeatCloudResultException(){}
     ...
     * @param cause  异常堆栈
     */
    public HeartbeatCloudResultException(Result result, Throwable cause) {
     ...
     * @param msg  错误消息
     */
    public HeartbeatCloudResultException(int code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }

    public HeartbeatCloudResultException(String code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }
     ...
     */
    public HeartbeatCloudResultException(Result result, String detail) {
     ...
     * @param cause  异常堆栈
     */
    public HeartbeatCloudResultException(Result result, String detail, Throwable cause) {
     ...
     * @param cause 异常堆栈
     */
    public HeartbeatCloudResultException(int code, String msg, Throwable cause) {
        super(msg, cause);
     ...
     * @param cause	异常堆栈
     */
    public HeartbeatCloudResultException(int code, Throwable cause) {
        super(cause);
        String msg = "";
