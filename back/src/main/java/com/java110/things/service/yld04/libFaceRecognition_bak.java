...
public interface libFaceRecognition_bak extends StdCallLibrary {
    ...
    public static class FaceFlags extends Structure {
        ...
        public String faceID;///= new byte[20];   //人员ID
        public String faceName;//= new byte[16];     //人员姓名
        ...
        public String resv;// = new byte[8184];
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"faceID", "faceName", "wgCardNO", "effectTime", "effectStartTime", "resv"});
        }
