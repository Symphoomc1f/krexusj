...
public class ControllerException extends RuntimeException {
     ...
     * @param cause  异常堆栈
     */
    public ControllerException(Result result, Throwable cause) {
     ...
     */
    public ControllerException(Result result, String detail) {
     ...
     * @param cause  异常堆栈
     */
    public ControllerException(Result result, String detail, Throwable cause) {
